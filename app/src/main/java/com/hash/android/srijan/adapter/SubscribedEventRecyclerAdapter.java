...
public class SubscribedEventRecyclerAdapter extends RecyclerView.Adapter<SubscribedEventRecyclerAdapter.ViewHolder> {
    ...
    public SubscribedEventRecyclerAdapter(ArrayList<Event> arrayList) {
    ...
    public void updateItems(ArrayList<Event> arrayList) {
        this.arrayList = arrayList;
    ...
    public void onBindViewHolder(SubscribedEventRecyclerAdapter.ViewHolder holder, int position) {
        holder.bind(position); //Binds the data items to the viewholder.
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(int position) {
            eventDetailHeading.setText(arrayList.get(position).getHead());
            eventDetailDescription.setText(arrayList.get(position).getContent());
            eventDetailImageView.setImageResource(arrayList.get(position).getImage());
            eventDetailIcon.setImageResource(arrayList.get(position).getIcon());
        }
    }
}
