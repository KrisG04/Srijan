...
public class EventsRecyclerAdapter extends RecyclerView.Adapter<EventsRecyclerAdapter.ViewHolder> {
    ...
    public EventsRecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.recyler_child_event, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.eventDetailHeading.setText(finalEvent.get(position).getHead());
        holder.eventDetailDescription.setText(finalEvent.get(position).getContent());
        holder.eventDetailImageView.setImageResource(finalEvent.get(position).getImage());
        holder.eventDetailIcon.setImageResource(finalEvent.get(position).getIcon());
//
